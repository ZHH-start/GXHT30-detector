...
//-- Static function prototypes ----------------------------------------------- static void EvalBoardPower_Init(void);
    ...
    while (1) {
        ...
        while (error == NO_ERROR) {
            ...
            if (status.bit.ResetDetected) {
                ...
                error = SHT3X_SetAlertLimits(70.0f, 50.0f,  // high set: RH [%], T [øC]
                                             68.0f, 48.0f,  // high clear: RH [%], T [øC]
                                   ...
                                   */
{
    ...
    GPIOA->CRH &= 0xFFFFFFF0;   // set general purpose input mode for User Button GPIOA->CRH	|= 0x00000004;	//
}
static void UserButton_Init(void) /* -- adapt this code for your platform --
                                   */
{
